...
public class ArrayPC {
   ...
   ExcelDsAlgo signinexcel;
	...
	@FindBy (xpath="//a[@href='array']") WebElement arrayGS;
	@FindBy (xpath="//h4[contains(text(),'Array')]") WebElement ArrayPage;
	@FindBy (xpath="//a[@href='arrays-in-python']") WebElement arraysInPython ;
    @FindBy (xpath="//strong[contains(text(),'Arrays in Python')]") WebElement ArrayInPythonPage;
	@FindBy (xpath="//a[@href='arrays-using-list']") WebElement ArraysUsingList ;
	@FindBy (xpath ="//p[contains(text(),'Arrays Using List')]") WebElement ArraysUsingListPage ;
	@FindBy (xpath="//a[@href='basic-operations-in-lists']") WebElement operationInList ;
	@FindBy (xpath ="//p[contains(text(),'Basic Operations in Lists')]") WebElement operationInListPage ;
	@FindBy (xpath="//a[@href='applications-of-array']") WebElement appOfArray ;
	@FindBy (xpath ="//p[contains(text(),'Applications of Array')]") WebElement appOfArrayPage ;
	@FindBy (xpath="//*[@id='content']/a") WebElement practiceQuest;
	@FindBy (xpath ="//a[contains(text(),'Search the array')]") WebElement practiceQuestPage ;
	@FindBy (xpath="//a[@class='btn btn-info']") WebElement tryhere;
	@FindBy (xpath="//pre[@class=' CodeMirror-line ']") WebElement enterText;
	
	@FindBy (xpath="//*[contains(text(),'Run')]") WebElement run;
