...
public class LinkedListPC {
	...
	@FindBy (xpath="//*[@id=\"navbarCollapse\"]/div[1]/div/a") WebElement dataStructureDD;
	...
	@FindBy (xpath="//a[@href='linked-list']") WebElement linkedListGS ;
	@FindBy(xpath="//h4[contains(text(),'Linked List')]") WebElement linkedlistpage;
	@FindBy (xpath="//a[@href='introduction']") WebElement introduction;
	@FindBy(xpath="//p[contains(text(),'Introduction')]")WebElement introductionPage;
	@FindBy (xpath="//a[@href='creating-linked-list']") WebElement creatingLinkedList;
	@FindBy(xpath="//p[contains(text(),'Creating Linked LIst')]")WebElement creatingLinkedListpage;
	@FindBy (xpath="//a[@href='types-of-linked-list']") WebElement typesofLinkedList ;
	@FindBy(xpath="//p[contains(text(),'Types of Linked List')]")WebElement typesofLinkedListpage;
	@FindBy (xpath="//a[@href='implement-linked-list-in-python']") WebElement implement ;
	@FindBy(xpath="//p[contains(text(),'Implement Linked List in Python')]")WebElement implementpage;
	@FindBy (xpath="//a[@href='traversal']") WebElement traversal ;
	@FindBy(xpath="//p[contains(text(),'Traversal')]")WebElement traversalpage;
	@FindBy (xpath="//a[@href='insertion-in-linked-list']") WebElement insertion ;
	@FindBy(xpath="//p[contains(text(),'Insertion')]")WebElement insertionpage;
	@FindBy (xpath="//a[@href='deletion-in-linked-list']") WebElement deletion;
	@FindBy(xpath="")WebElement deletionpage;
	@FindBy (xpath="//*[@id='content']/a") WebElement practicequesLL ;	
	@FindBy(xpath="//p[contains(text(),'Deletion')]")WebElement practicequesLLpage;
	@FindBy (xpath="//a[@class='btn btn-info']") WebElement tryhere ;
	@FindBy (xpath="//pre[@class=' CodeMirror-line ']") WebElement enterText;
