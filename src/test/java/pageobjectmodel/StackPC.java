...
public class StackPC {
	...
	@FindBy (xpath="//a[@href='stack']") WebElement stackGS  ;
	@FindBy (xpath ="//h4[contains(text(),'Stack')]") WebElement stackPage;
	@FindBy (xpath="//a[@href='operations-in-stack']") WebElement operation  ;
	@FindBy (xpath="//strong/p[contains(text(),'Operations in Stack')]") WebElement operationPage;
	@FindBy (xpath="//a[@href='implementation']") WebElement implementation ;
	@FindBy (xpath="//strong/p[contains(text(),'Implementation')]") WebElement implementationPage;
	@FindBy (xpath="//a[@href='stack-applications']") WebElement  application;
	@FindBy (xpath="//strong/p[contains(text(),'Applications')]") WebElement applicationPage;
	@FindBy (xpath="//*[@id='content']/a") WebElement pracQuest ;
